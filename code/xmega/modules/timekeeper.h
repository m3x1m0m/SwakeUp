...
#define TIMEKEEPER_DAYS_MONDAY          1
#define TIMEKEEPER_DAYS_TUESDAY         2
#define TIMEKEEPER_DAYS_WEDNESDAY       3
#define TIMEKEEPER_DAYS_THURSDAY        4
#define TIMEKEEPER_DAYS_FRIDAY          5
#define TIMEKEEPER_DAYS_SATURDAY        6
#define TIMEKEEPER_DAYS_SUNDAY          7
